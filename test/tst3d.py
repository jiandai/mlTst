...
model = Sequential()
model.add(Convolution3D(16,8,8,8,input_shape=(1,50,512,512),border_mode='valid',activation = 'relu')) # border_mode: 'valid', 'same' or 'full'. ('full' requires the Theano backend.)
model.add(MaxPooling3D(pool_size=(2, 4, 4)))
model.add(Convolution3D(16,4,8,8,border_mode='valid',activation = 'relu'))
model.add(MaxPooling3D(pool_size=(2, 4, 4)))
